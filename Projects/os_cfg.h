...
#define OS_LOWEST_PRIO           100u   /* 最低优先级*//* Defines the lowest priority that can be assigned ...         */
...
#define OS_TICKS_PER_SEC        200u   /* 设定一秒节拍的数量 *//* Set the number of ticks in one second                        */
